...
func (suite *KeeperTestSuite) TestQueryParametersPool(t *testing.T) {
	legacyQuerierCdc := codec.NewAminoCodec(suite.legacyAmino)
	querier := keeper.NewQuerier(suite.stakingKeeper, legacyQuerierCdc.LegacyAmino)
...
func (suite *KeeperTestSuite) TestQueryValidators(t *testing.T) {
...
func (suite *KeeperTestSuite) TestQueryDelegation(t *testing.T) {
	params := suite.stakingKeeper.GetParams(suite.ctx)
	legacyQuerierCdc := codec.NewAminoCodec(suite.legacyAmino)
	querier := keeper.NewQuerier(suite.stakingKeeper, legacyQuerierCdc.LegacyAmino)
...
func (suite *KeeperTestSuite) TestQueryValidatorDelegations_Pagination(t *testing.T) {
	cases := []struct {
		page            int
		limit           int
		expectedResults int
...
func (suite *KeeperTestSuite) TestQueryRedelegations(t *testing.T) {
	legacyQuerierCdc := codec.NewAminoCodec(suite.legacyAmino)
	querier := keeper.NewQuerier(suite.stakingKeeper, legacyQuerierCdc.LegacyAmino)
...
func (suite *KeeperTestSuite) TestQueryUnbondingDelegation(t *testing.T) {
	legacyQuerierCdc := codec.NewAminoCodec(suite.legacyAmino)
	querier := keeper.NewQuerier(suite.stakingKeeper, legacyQuerierCdc.LegacyAmino)
...
func (suite *KeeperTestSuite) TestQueryHistoricalInfo(t *testing.T) {
	legacyQuerierCdc := codec.NewAminoCodec(suite.legacyAmino)
	querier := keeper.NewQuerier(suite.stakingKeeper, legacyQuerierCdc.LegacyAmino)
